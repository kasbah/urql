...
function (_Component) {
  ...
  function UrqlClient() {
    ...
    return (_temp = _this = _Component.call.apply(_Component, [this].concat(args)) || this, _this.state = {
      ...
      fetching: false,
      loaded: false
    }, _this.willUpdateSubscription = false, _this.subscription = null, _this.query = null, _this.mutations = {}, _this.typeNames = [], _this.unsubscribe = null, _this.subscriptionSub = null, _this.querySub = null, _this.invalidate = function (queryObject) {
      ...
      if (props.query) {
        ...
        _this.query = Array.isArray(props.query) ? props.query.map(formatTypeNames) : formatTypeNames(props.query); // Subscribe to change listener
      ...
      if (props.subscription) {
        // Loop through and add typenames
        _this.subscription = formatTypeNames(props.subscription); // Fetch initial data
      ...
      if (!Array.isArray(_this.query)) {
        ...
        _this.querySub = zipObservables(queries$).subscribe({
          error: function error(e) {
            _this.setState({
